...
test_that("Main table results match", {
  ...
  refTables <- list(
    ...
    type3 = list("TRUE", 4, 1.9059626359792, 46.2991161290448, 0.115857414147637,
                 ...
                 0.0750202880830829, 1.47317659150752, "TRUE", 1, 0.166654582934623,
                 4.04832694150036, 0.684030683889984, 4.04832694150036, "contGamma",
                 0.00163723112216545, 0, 0.00176978340871021, 1, "FALSE", 94,
...
test_that("Field - Chapter 6 results match", {
  ...
  jaspTools::expect_equal_tables(table,
                      list("Dose", 25.1851942083821, 2, 12.592597104191, 4.14192880386377,
                           ...
                           1, 15.0757477099169, 4.9586811332752, 0.0348333806474409, "FALSE",
  ...
  jaspTools::expect_equal_tables(table,
                      list("Dose", 36.5575599693692, 2, 18.2787799846846, 7.483568988423,
                           ...
                           4.18145584551367, 0.0276671129121842, "TRUE", "Residuals", 58.6205218808138,
