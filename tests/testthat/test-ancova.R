...
test_that("Field - Chapter 6 results match", {
  ...
  table <- results$results$anovaContainer$collection$anovaContainer_postHocContainer$collection$anovaContainer_postHocContainer_postHocStandardContainer$collection[[1]]$data
  jaspTools::expect_equal_tables(table,
                                 list("TRUE", 0.538336190074754, -0.0194100366350696, "Dose1", "Dose2", -1.78324124481148,
                                      -2.83630538964887, 0.129983128349044, -2.1023947223315, -0.858078871455783,
                                      "FALSE", 0.763324066789792, -0.0155779657803681, "Dose1", "Dose3", -2.18556663740395,
                                      -3.97107607430337, 0.0302155022603601, -2.77136409916095, -0.844312084720959,
                                      "FALSE", 0.775278163963213, 0.00383207085470177, "Dose2", "Dose3", -0.410252544853602,
                                      -2.12122714048355, 0.932499470707816, -0.541407321622226, 0.97252478121536
                                 ))
