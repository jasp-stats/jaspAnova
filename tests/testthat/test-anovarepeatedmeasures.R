...
test_that("Within subjects table results match R, SAS and SPSS 1", { 
  options <- jaspTools::analysisOptions("AnovaRepeatedMeasures")
  ...
  options$sphericityNone <- FALSE
  options$sphericityHuynhFeldt <- FALSE
  options$sphericityGreenhouseGeisser <- FALSE
  
  results <- jaspTools::runAnalysis(name = "AnovaRepeatedMeasures", dataset = "Ranova.csv",
                                    options = options)
  
  # main table- Within Subjects Effects table
  # 
...
test_that("Friedman results match R, SAS and SPSS", { 
  options$repeatedMeasuresFactors <- list(
    list(name = "RMFactor1", levels = c("Treatment.I", "Treatment.II", "Treatment.III", "Treatment.IV"))
  )
  ...
  results <- jaspTools::runAnalysis(name = "AnovaRepeatedMeasures", dataset="Friedman.csv",
                                    options = options)
  ...
  # Nonparametrics
  nonPara1 <- results[["results"]]$rmAnovaContainer$collection$rmAnovaContainer_nonparametricContainer$collection
  resultTable <- nonPara1$rmAnovaContainer_nonparametricContainer_friedmanTable$data
