...
#' }
#' @param betweenSubjectFactors, Select when the subjects have been assigned into two or more separate groups
...
#' @param repeatedMeasuresFactors, The within-subjects (repeated measures variable). Here the repeated measures factors of interest and the different levels that belong to the factor can be labelled.
