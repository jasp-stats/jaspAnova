	...
	Group
	{
		CheckBox
		{
			...
			RadioButtonGroup
			{
				...
				RadioButton { value: "raw";			label: qsTr("Raw"); info: qsTr("Appends raw residulas, meaning the simple difference between observed values and predicted values. Selected by default.") ;checked: true	}
