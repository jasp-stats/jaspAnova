...
Section
{
	...
	Group
	{
		...
		CheckBox
		{
			...
			label: 	qsTr("Error bars"); info: qsTr("By selecting this option, error bars will be displayed in the plot. The error bars can represent either confidence intervals/credible intervals or standard errors.")
