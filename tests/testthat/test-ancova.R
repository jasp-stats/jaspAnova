...
test_that("Main table results match", {
  ...
  refTables <- list(
    ...
    type2 = list("facFive", 185.196464516179, 4, 46.2991161290447, 1.90596263597919,
                 ...
                 2283.42194856002, 94, 24.2917228570215, "", "", "TRUE", "",
                 "", "", ""),
    type3 = list("TRUE", 4, 1.90596263597919, 46.2991161290447, 0.115857414147638,
                 185.196464516179, "facFive", 1.66988539411878, 0.0750202880830827,
                 0.65112836582649, 1.47317659150752, "TRUE", 1, 0.166654582934623,
                 4.04832694150036, 0.684030683889984, 4.04832694150036, "contGamma",
                 0.0365030836192795, 0.00176978340871021, 0, 1, "TRUE", 94, "",
...
test_that("Main table results match for three-way ANOVA", {
  ...
  results <- jaspTools::runAnalysis("Ancova", "test.csv", options)
  table <- results[["results"]][["anovaContainer"]][["collection"]][["anovaContainer_anovaTable"]][["data"]]
  jaspTools::expect_equal_tables(table, list("TRUE", 4, 0.751434182416166, 0.849676498436303, 0.560010211401304,
                                             3.39870599374521, "facFive", 0.0306455607167558, 0.036652761739989,
                                             0, "FALSE", 1, 0.0718225589534214, 0.0812126222473069, 0.789399900467283,
                                             0.0812126222473069, "contBinom", 0.000732280565199537, 0.000908320519612062,
                                             0, "FALSE", 1, 4.03921343627837, 4.56729918505772, 0.0478686068240799,
                                             4.56729918505772, "facGender", 0.0411825691144995, 0.0486422410464898,
                                             0.0306741348702008, "FALSE", 4, 0.801330995992751, 0.906096808870625,
                                             0.527940897125053, 3.6243872354825, "facFive <unicode> facGender",
                                             0.0326804905427017, 0.038991683611587, 0, "FALSE", 1, 1.08113657469412,
                                             1.22248409855909, 0.301615301439538, 1.22248409855909, "contBinom <unicode> facGender",
                                             0.0110229336508093, 0.0135005148645175, 0.000818894193269, "FALSE",
                                             4, 0.702807193128186, 0.79469202879871, 0.592348641591512, 3.17876811519484,
                                             "facFive <unicode> contBinom <unicode> facGender", 0.0286624178313653,
                                             0.0343623829478194, 0, "TRUE", 1, 0.0608023312347779, 0.0687516127283629,
                                             0.805871897218375, 0.0687516127283629, "contGamma", 0.000619921736719625,
                                             0.000769057857268374, 0, "FALSE", 4, 0.215937435642924, 0.244169041669679,
                                             0.928844739039309, 0.976676166678715, "facFive <unicode> contBinom",
                                             0.00880652484258534, 0.0108152916104723, 0, "TRUE", 79, "",
